...
// @protocol RSKImageCropViewControllerDelegate <NSObject>
    ...
    interface RSKImageCropViewControllerDelegate
    {
        ...
        void ImageCropViewController(RSKImageCropViewController controller, UIImage croppedImage, CGRect cropRect,
            nfloat rotationAngle);

        // @optional -(void)imageCropViewControllerDidDisplayImage:(RSKImageCropViewController * _Nonnull)controller;
...
// @interface RSKImageCropViewControllerProtectedMethods (RSKImageCropViewController)
    ...
    public interface RSKImageCropViewController_RSKImageCropViewControllerProtectedMethods
    {
        // -(void)cropImage;
        [Export("cropImage")]
        void CropImage();
...
// @interface RSKImageScrollView : UIScrollView
    ...
    public interface RSKImageScrollView
    {
...
// @interface RSKImageCropper (UIApplication)
    ...
    public interface UIApplication_RSKImageCropper
    {
